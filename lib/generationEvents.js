 ...
 * Auth header:    Authorization: Bearer BRAIN_API_KEY
 */
...
function buildAuthHeaders() {
    return {
        ...
        // Backward compatible with older internal services; Brain currently reads Authorization.
        'x-api-key': BRAIN_API_KEY
    };
}

module.exports = { logEvent, buildEventPayload, buildAuthHeaders };
